...
class ReserveTest extends TestCase
{
    ...
    public function testCanView_indexPage()
    {
        ...
        $this->get('/')
             ->assertStatus(200)
             ->assertSee('<title>受付状況 - あかつき動物病院 - リザベル</title>')
    ...
    public function testCanView_createPage_typeFiest()
    {
        ...
        $this->get('/reserve/create/1')
             ->assertStatus(200)
             ->assertSee('<title>予約受付 - あかつき動物病院 - リザベル</title>')
             ->assertSee('<h1>あかつき動物病院　予約受付</h1>')
    ...
    public function testCanView_confirmPage_typeFiest()
    {
        ...
        $this->post('/reserve/confirm',[
             ...
             ->assertSee('<input type="hidden" name="pet_type"        value="犬、猫、ウサギ、インコ、トカゲ" />')
             ...
             ->assertSee('<dd><span>犬、猫、ウサギ、インコ、トカゲ</span></dd>')
    ...
    public function testCanReserve_typeFiest()
    {
        ...
        $this->get('/reserve/complete?careType=1&receptionNo=1')
             ->assertStatus(200)
             ->assertSee('<title>予約完了 - あかつき動物病院 - リザベル</title>')
             ->assertSee('<h1>あかつき動物病院　予約完了</h1>')
        ...
        // 登録されたことを確認
        $this->assertDatabaseHas('reserves', ['id'=>1,'care_type'=>1,'status'=>10,'medical_card_no'=>'123456','name'=>'動物　太郎','email'=>'m-fujisawa@it-craft.co.jp','tel'=>'0331234567','pet_type'=>'犬、猫、ウサギ、インコ、トカゲ','pet_name'=>'ポチ、ミケ、ぴょん、ピー、ごまぞー','conditions'=>'おもちゃを飲み込んだ',]);
    ...
    public function testCanReserve_typeRepeat()
    {
        ...
        // 登録されたことを確認
        $this->assertDatabaseHas('reserves', ['id'=>1,'care_type'=>2,'status'=>10,'medical_card_no'=>'123456','name'=>'動物　太郎','email'=>'m-fujisawa@it-craft.co.jp','tel'=>'0331234567','pet_type'=>'犬、猫、ウサギ、インコ、トカゲ','pet_name'=>'ポチ、ミケ、ぴょん、ピー、ごまぞー','conditions'=>'おもちゃを飲み込んだ',]);
