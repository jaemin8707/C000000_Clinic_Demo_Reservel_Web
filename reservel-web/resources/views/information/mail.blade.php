...
<main class="data_main">
 <p class="data_main_comment">迷惑メールの設定によっては、受付システムからのメールが届かない場合があります。<br>
  メールが届かない場合は、受付システムからのメールが受信できるようにドメイン指定受信で「@yahoo.co.jp」を許可するように設定してください。</p>
    ...
    <section class="data_inner">	
	 ...
	 <section class="data_inner">	
	  ...
	  <p class="data_inner_comment">下記のページの「受信リスト設定」を参照いただき、「@yahoo.co.jp」を受信するドメインに追加してください。</p>
	  ...
	  <p class="data_inner_comment">下記のページを参照いただき、受信リスト設定で「@yahoo.co.jp」を追加してください。</p>
	  ...
	  <p class="data_inner_comment">下記のページを参照いただき、メール設定で「@yahoo.co.jp」を許可するメールとして登録してください。</p>
